...
public class SightingDAOImpl implements SightingDAO {
    ...
    private Hero getHeroForSighting(int sightingID) {
        ...
        return jdbc.queryForObject(SELECT_HERO_FOR_SIGHTING, new HeroDAOImpl.HeroMapper(), sightingID);
    }
    ...
    private Location getLocationForSighting(int sightingID) {
        ...
        return jdbc.queryForObject(SELECT_LOC_FOR_SIGHTING, new LocationDAOImpl.LocationMapper(), sightingID);
    }
